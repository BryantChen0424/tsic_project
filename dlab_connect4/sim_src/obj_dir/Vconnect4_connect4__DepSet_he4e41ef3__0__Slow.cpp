...
VL_ATTR_COLD void Vconnect4_connect4___stl_sequent__TOP__connect4__0(Vconnect4_connect4* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+      Vconnect4_connect4___stl_sequent__TOP__connect4__0\n"); );
...
VL_ATTR_COLD void Vconnect4_connect4___ctor_var_reset(Vconnect4_connect4* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+      Vconnect4_connect4___ctor_var_reset\n"); );
    Vconnect4__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    ...
    vlSelf->re_err_nxt = VL_RAND_RESET_I(1);
    vlSelf->re_is_finished_nxt = VL_RAND_RESET_I(1);
    vlSelf->re_winner_nxt = VL_RAND_RESET_I(1);
    vlSelf->re_tie_nxt = VL_RAND_RESET_I(1);
    vlSelf->S = VL_RAND_RESET_I(4);
    vlSelf->S_nxt = VL_RAND_RESET_I(4);
    vlSelf->occupied = VL_RAND_RESET_Q(42);
    vlSelf->whos = VL_RAND_RESET_Q(42);
    vlSelf->occupied_nxt = VL_RAND_RESET_Q(42);
    vlSelf->whos_nxt = VL_RAND_RESET_Q(42);
    vlSelf->player_id = VL_RAND_RESET_I(1);
    vlSelf->player_id_nxt = VL_RAND_RESET_I(1);
    vlSelf->col_id = VL_RAND_RESET_I(3);
    vlSelf->col_id_nxt = VL_RAND_RESET_I(3);
    vlSelf->row_id = VL_RAND_RESET_I(3);
    vlSelf->row_id_nxt = VL_RAND_RESET_I(3);
    vlSelf->wj_op_ready = VL_RAND_RESET_I(1);
    vlSelf->wj_op_valid = VL_RAND_RESET_I(1);
    vlSelf->wj_op_valid_nxt = VL_RAND_RESET_I(1);
    vlSelf->wj_re_ready = VL_RAND_RESET_I(1);
    vlSelf->wj_re_ready_nxt = VL_RAND_RESET_I(1);
    vlSelf->wj_re_valid = VL_RAND_RESET_I(1);
    vlSelf->wj_re_is_finished = VL_RAND_RESET_I(1);
    vlSelf->op_fire = VL_RAND_RESET_I(1);
    vlSelf->re_fire = VL_RAND_RESET_I(1);
    vlSelf->wj_op_fire = VL_RAND_RESET_I(1);
    vlSelf->wj_re_fire = VL_RAND_RESET_I(1);
    vlSelf->col_full = VL_RAND_RESET_I(7);
    vlSelf->i = VL_RAND_RESET_I(32);
    vlSelf->__Vlvbound_he09ab045__0 = VL_RAND_RESET_I(1);
    vlSelf->__Vlvbound_h1937b198__0 = VL_RAND_RESET_I(1);
    vlSelf->__Vlvbound_ha9697794__0 = VL_RAND_RESET_I(1);
    vlSelf->__Vlvbound_h0ff1056b__0 = VL_RAND_RESET_I(1);
    vlSelf->wj__DOT__clk = VL_RAND_RESET_I(1);
    vlSelf->wj__DOT__rst_n = VL_RAND_RESET_I(1);
    vlSelf->wj__DOT__occupied = VL_RAND_RESET_Q(42);
    vlSelf->wj__DOT__whos = VL_RAND_RESET_Q(42);
    vlSelf->wj__DOT__op_ready = VL_RAND_RESET_I(1);
    vlSelf->wj__DOT__op_valid = VL_RAND_RESET_I(1);
    vlSelf->wj__DOT__re_ready = VL_RAND_RESET_I(1);
    vlSelf->wj__DOT__re_valid = VL_RAND_RESET_I(1);
    vlSelf->wj__DOT__re_is_finished = VL_RAND_RESET_I(1);
    vlSelf->wj__DOT__op_ready_nxt = VL_RAND_RESET_I(1);
    vlSelf->wj__DOT__re_valid_nxt = VL_RAND_RESET_I(1);
    vlSelf->wj__DOT__re_is_finished_nxt = VL_RAND_RESET_I(1);
    vlSelf->wj__DOT__S = VL_RAND_RESET_I(4);
    vlSelf->wj__DOT__S_nxt = VL_RAND_RESET_I(4);
    vlSelf->wj__DOT__rlim = VL_RAND_RESET_I(3);
    vlSelf->wj__DOT__rlim_nxt = VL_RAND_RESET_I(3);
    vlSelf->wj__DOT__llim = VL_RAND_RESET_I(3);
    vlSelf->wj__DOT__llim_nxt = VL_RAND_RESET_I(3);
    vlSelf->wj__DOT__tlim = VL_RAND_RESET_I(3);
    vlSelf->wj__DOT__tlim_nxt = VL_RAND_RESET_I(3);
    vlSelf->wj__DOT__blim = VL_RAND_RESET_I(3);
    vlSelf->wj__DOT__blim_nxt = VL_RAND_RESET_I(3);
    vlSelf->wj__DOT__c = VL_RAND_RESET_I(3);
    vlSelf->wj__DOT__c_nxt = VL_RAND_RESET_I(3);
    vlSelf->wj__DOT__r = VL_RAND_RESET_I(3);
    vlSelf->wj__DOT__r_nxt = VL_RAND_RESET_I(3);
    vlSelf->wj__DOT__op_fire = VL_RAND_RESET_I(1);
    vlSelf->wj__DOT__re_fire = VL_RAND_RESET_I(1);
    vlSelf->wj__DOT__occupied_all = VL_RAND_RESET_I(1);
    vlSelf->wj__DOT__whos_all = VL_RAND_RESET_I(1);
    vlSelf->wj__DOT__c0 = VL_RAND_RESET_I(3);
    vlSelf->wj__DOT__c1 = VL_RAND_RESET_I(3);
    vlSelf->wj__DOT__c2 = VL_RAND_RESET_I(3);
    vlSelf->wj__DOT__c3 = VL_RAND_RESET_I(3);
    vlSelf->wj__DOT__r0 = VL_RAND_RESET_I(3);
    vlSelf->wj__DOT__r1 = VL_RAND_RESET_I(3);
    vlSelf->wj__DOT__r2 = VL_RAND_RESET_I(3);
    vlSelf->wj__DOT__r3 = VL_RAND_RESET_I(3);
}
