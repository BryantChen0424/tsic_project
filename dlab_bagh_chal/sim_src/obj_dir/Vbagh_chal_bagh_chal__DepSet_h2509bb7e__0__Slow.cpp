...
VL_ATTR_COLD void Vbagh_chal_bagh_chal___eval_initial__TOP__bagh_chal(Vbagh_chal_bagh_chal* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+      Vbagh_chal_bagh_chal___eval_initial__TOP__bagh_chal\n"); );
    Vbagh_chal__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.su__DOT__jdx = 1U;
    vlSelfRef.su__DOT__jdx = 2U;
    vlSelfRef.su__DOT__jdx = 3U;
    vlSelfRef.su__DOT__jdx = 4U;
    vlSelfRef.su__DOT__jdx = 5U;
    vlSelfRef.su__DOT__jdx = 1U;
    vlSelfRef.su__DOT__jdx = 2U;
    vlSelfRef.su__DOT__jdx = 3U;
    vlSelfRef.su__DOT__jdx = 4U;
    ...
    vlSelfRef.su__DOT__jdx = 4U;
    vlSelfRef.su__DOT__jdx = 5U;
    vlSelfRef.su__DOT__idx = 1U;
    vlSelfRef.su__DOT__idx = 2U;
    vlSelfRef.su__DOT__idx = 3U;
    vlSelfRef.su__DOT__idx = 4U;
    vlSelfRef.su__DOT__idx = 5U;
    vlSelfRef.su__DOT__idx = 1U;
    vlSelfRef.su__DOT__idx = 2U;
    vlSelfRef.su__DOT__idx = 3U;
    vlSelfRef.su__DOT__idx = 4U;
...
VL_ATTR_COLD void Vbagh_chal_bagh_chal___stl_sequent__TOP__bagh_chal__0(Vbagh_chal_bagh_chal* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+      Vbagh_chal_bagh_chal___stl_sequent__TOP__bagh_chal__0\n"); );
    Vbagh_chal__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
...
VL_ATTR_COLD void Vbagh_chal_bagh_chal___ctor_var_reset(Vbagh_chal_bagh_chal* vlSelf) {
    VL_DEBUG_IF(VL_DBG_MSGF("+      Vbagh_chal_bagh_chal___ctor_var_reset\n"); );
    Vbagh_chal__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    ...
    vlSelf->op_ready_nxt = VL_RAND_RESET_I(1);
    vlSelf->re_valid_nxt = VL_RAND_RESET_I(1);
    vlSelf->re_is_finished_nxt = VL_RAND_RESET_I(1);
    vlSelf->re_possible_ops_nxt = VL_RAND_RESET_I(4);
    vlSelf->S = VL_RAND_RESET_I(4);
    vlSelf->S_nxt = VL_RAND_RESET_I(4);
    vlSelf->occupied = VL_RAND_RESET_I(25);
    vlSelf->occupied_nxt = VL_RAND_RESET_I(25);
    vlSelf->whos = VL_RAND_RESET_I(25);
    vlSelf->whos_nxt = VL_RAND_RESET_I(25);
    vlSelf->ci = VL_RAND_RESET_I(5);
    vlSelf->ci_nxt = VL_RAND_RESET_I(5);
    vlSelf->cj = VL_RAND_RESET_I(5);
    vlSelf->cj_nxt = VL_RAND_RESET_I(5);
    vlSelf->pi = VL_RAND_RESET_I(5);
    vlSelf->pi_nxt = VL_RAND_RESET_I(5);
    vlSelf->pj = VL_RAND_RESET_I(5);
    vlSelf->pj_nxt = VL_RAND_RESET_I(5);
    vlSelf->goats_in_hand = VL_RAND_RESET_I(5);
    vlSelf->goats_in_hand_nxt = VL_RAND_RESET_I(5);
    vlSelf->goats_killed = VL_RAND_RESET_I(5);
    vlSelf->goats_killed_nxt = VL_RAND_RESET_I(5);
    vlSelf->t0i = VL_RAND_RESET_I(5);
    vlSelf->t0i_nxt = VL_RAND_RESET_I(5);
    vlSelf->t0j = VL_RAND_RESET_I(5);
    vlSelf->t0j_nxt = VL_RAND_RESET_I(5);
    vlSelf->t1i = VL_RAND_RESET_I(5);
    vlSelf->t1i_nxt = VL_RAND_RESET_I(5);
    vlSelf->t1j = VL_RAND_RESET_I(5);
    vlSelf->t1j_nxt = VL_RAND_RESET_I(5);
    vlSelf->t2i = VL_RAND_RESET_I(5);
    vlSelf->t2i_nxt = VL_RAND_RESET_I(5);
    vlSelf->t2j = VL_RAND_RESET_I(5);
    vlSelf->t2j_nxt = VL_RAND_RESET_I(5);
    vlSelf->t3i = VL_RAND_RESET_I(5);
    vlSelf->t3i_nxt = VL_RAND_RESET_I(5);
    vlSelf->t3j = VL_RAND_RESET_I(5);
    vlSelf->t3j_nxt = VL_RAND_RESET_I(5);
    vlSelf->check_tiger_id = VL_RAND_RESET_I(4);
    vlSelf->check_tiger_id_nxt = VL_RAND_RESET_I(4);
    vlSelf->op_fire = VL_RAND_RESET_I(1);
    vlSelf->re_fire = VL_RAND_RESET_I(1);
    vlSelf->i_dist = VL_RAND_RESET_I(5);
    vlSelf->j_dist = VL_RAND_RESET_I(5);
    vlSelf->opij2idx = VL_RAND_RESET_I(5);
    vlSelf->cij2idx = VL_RAND_RESET_I(5);
    vlSelf->pij2idx = VL_RAND_RESET_I(5);
    vlSelf->su_ci = VL_RAND_RESET_I(5);
    vlSelf->su_cj = VL_RAND_RESET_I(5);
    vlSelf->su_o_tigers_cantmove = VL_RAND_RESET_I(1);
    vlSelf->su_o_update = VL_RAND_RESET_I(25);
    vlSelf->idx = VL_RAND_RESET_I(32);
    vlSelf->__Vlvbound_ha134e953__0 = VL_RAND_RESET_I(1);
    vlSelf->__Vlvbound_h13906274__0 = VL_RAND_RESET_I(1);
    vlSelf->__Vlvbound_h5d1d6572__0 = VL_RAND_RESET_I(1);
    vlSelf->__Vlvbound_h823c4ae0__0 = VL_RAND_RESET_I(1);
    vlSelf->__Vlvbound_ha134e953__1 = VL_RAND_RESET_I(1);
    vlSelf->__Vlvbound_h13906274__1 = VL_RAND_RESET_I(1);
    vlSelf->__Vlvbound_h5d1d6572__1 = VL_RAND_RESET_I(1);
    vlSelf->__Vlvbound_h823c4ae0__1 = VL_RAND_RESET_I(1);
    vlSelf->__Vlvbound_h8ccd81e1__0 = VL_RAND_RESET_I(1);
    vlSelf->__Vlvbound_hc9a42266__0 = VL_RAND_RESET_I(1);
    vlSelf->su__DOT__occupied = VL_RAND_RESET_I(25);
    vlSelf->su__DOT__whos = VL_RAND_RESET_I(25);
    vlSelf->su__DOT__S = VL_RAND_RESET_I(4);
    vlSelf->su__DOT__ci = VL_RAND_RESET_I(5);
    vlSelf->su__DOT__cj = VL_RAND_RESET_I(5);
    vlSelf->su__DOT__goats_in_hand = VL_RAND_RESET_I(5);
    vlSelf->su__DOT__o_tigers_cantmove = VL_RAND_RESET_I(1);
    vlSelf->su__DOT__o_update = VL_RAND_RESET_I(25);
    vlSelf->su__DOT__all_vacant = VL_RAND_RESET_I(25);
    vlSelf->su__DOT__all_goat = VL_RAND_RESET_I(25);
    vlSelf->su__DOT__all_tiger = VL_RAND_RESET_I(25);
    vlSelf->su__DOT__cgoat_can_goto = VL_RAND_RESET_I(25);
    vlSelf->su__DOT__ctiger_can_goto = VL_RAND_RESET_I(25);
    vlSelf->su__DOT__ctiger_can_jumpto = VL_RAND_RESET_I(25);
    vlSelf->su__DOT__idx = VL_RAND_RESET_I(32);
    vlSelf->su__DOT__jdx = VL_RAND_RESET_I(32);
}
